  ...
  return (
    ...
    >
      <div className="w-full h-full flex flex-col p-0 m-0 items-center text-center gap-5">
		...
		<svg className="w-full h-auto" height="553" viewBox="0 0 424 553" fill="black" xmlns="http://www.w3.org/2000/svg">
			<g clipPath="url(#clip0_2018_3)">
				<path d="M43.0948 1L1 48.7056V552H383.01L423 506.68V1H43.0948Z"
				              stroke="currentColor"
							  strokeWidth="3"
							  fill="currentColor"
							  fillOpacity="0.2" />
				<path d="M62.3067 17L25 49.381V391H363.559L399 360.238V17H62.3067Z" stroke="currentColor" strokeWidth="2" className="creator-img-container stroke-2 fill-primary"/>
			</g>
            <g>
        ...
        <div
          className="content absolute bottom-0 left-0 w-full flex flex-col items-center gap-10 p-5">
          <h2 className="text-4xl font-heading">{content}</h2>
        </div>
      </div>
