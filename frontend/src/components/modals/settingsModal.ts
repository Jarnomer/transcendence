  ...
  const settingsContent = `
    ...
    <div id="settings-modal" class="modal-content relative w-full h-full text-center">
  		<svg class="absolute top-0 left-0 w-full pointer-events-none" viewBox="0 0 426 245" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<path d="M175.189 242.21L167.719 234.74H114.439L121.939 242.21H175.189Z" class="fill-primary"/>
			<path d="M116.33 242.21L108.86 234.71H103.85L111.38 242.27L116.33 242.21Z" class="fill-primary"/>
			<path d="M106.101 242.21L98.6311 234.71H93.6211L101.151 242.27L106.101 242.21Z" class="fill-primary"/>
			<path d="M95.301 242.21L87.801 234.71H82.791L90.351 242.27L95.301 242.21Z" class="fill-primary"/>
		...
		<p class="mb-4">Not much to do here yet...</p>
